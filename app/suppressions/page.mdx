...
Un-suppression is a deliberate act done in the app, on the **Suppressions** page,
per address, with the reason and source visible. Two reasons for that asymmetry:
